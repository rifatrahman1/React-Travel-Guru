    ...
    return (
        ...
        <div className='w-[600px] mx-auto px-14 py-10 bg-white shadow-2xl rounded-2xl'>
          ...
          <div className='flex flex-col'>
            <input className='border-b-2 mt-5 border-x-0 border-t-0 font-bold border-[#C5C5C5] focus:outline-none px-2 py-3 rounded-none' type="text" name="text" placeholder='First Name' id="" />
            <input className='border-b-2 mt-5 border-x-0 border-t-0 font-bold border-[#C5C5C5] focus:outline-none px-2 py-3 rounded-none' type="text" name="text" placeholder='Last Name' id="" />
            ...
            <input className='border-b-2 mt-5 border-x-0 border-t-0 text-black font-bold border-[#C5C5C5] focus:outline-none px-2 py-3 rounded-none' type="password" name="password" placeholder='Confirm Password' id="" />
